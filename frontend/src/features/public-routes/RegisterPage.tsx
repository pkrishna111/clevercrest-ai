        ...
        {isRegistered ? <div className="register-success" role="status" aria-live="polite" aria-atomic="true">
          ...
          <form className="register-form" noValidate onSubmit={handleSubmit}>
            <fieldset disabled={isSubmitting}>
              <div className="register-field"><label htmlFor="register-first-name">First name</label><input id="register-first-name" name="first_name" type="text" autoComplete="given-name" required aria-invalid={Boolean(fieldErrors.firstName)} aria-describedby={fieldErrors.firstName ? 'register-first-name-error' : undefined} />{fieldErrors.firstName && <p className="register-field-error" id="register-first-name-error">{fieldErrors.firstName}</p>}</div>
              <div className="register-field"><label htmlFor="register-last-name">Last name <span>(optional)</span></label><input id="register-last-name" name="last_name" type="text" autoComplete="family-name" /></div>
              <div className="register-field"><label htmlFor="register-email">Email</label><input id="register-email" name="email" type="email" autoComplete="email" required aria-invalid={Boolean(fieldErrors.email)} aria-describedby={fieldErrors.email ? 'register-email-error' : undefined} />{fieldErrors.email && <p className="register-field-error" id="register-email-error">{fieldErrors.email}</p>}</div>
              <div className="register-field"><label htmlFor="register-organization-name">Organization name</label><input id="register-organization-name" name="organization_name" type="text" autoComplete="organization" required aria-invalid={Boolean(fieldErrors.organizationName)} aria-describedby={fieldErrors.organizationName ? 'register-organization-name-error' : undefined} />{fieldErrors.organizationName && <p className="register-field-error" id="register-organization-name-error">{fieldErrors.organizationName}</p>}</div>
              <div className="register-field"><label htmlFor="register-password">Password</label><input id="register-password" name="password" type="password" autoComplete="new-password" required aria-invalid={Boolean(fieldErrors.password)} aria-describedby={fieldErrors.password ? 'register-password-error' : undefined} />{fieldErrors.password && <p className="register-field-error" id="register-password-error">{fieldErrors.password}</p>}</div>
              <div className="register-field"><label htmlFor="register-confirm-password">Confirm password</label><input id="register-confirm-password" name="confirm_password" type="password" autoComplete="new-password" required aria-invalid={Boolean(fieldErrors.confirmPassword)} aria-describedby={fieldErrors.confirmPassword ? 'register-confirm-password-error' : undefined} />{fieldErrors.confirmPassword && <p className="register-field-error" id="register-confirm-password-error">{fieldErrors.confirmPassword}</p>}</div>
              {requestError && <div className="register-error" role="alert"><span aria-hidden="true" />{requestError}</div>}
              <div className="register-actions"><button className="register-submit" type="submit">{isSubmitting ? 'Creating account…' : 'Create account'}</button></div>
            </fieldset>
